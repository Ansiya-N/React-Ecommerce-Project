...
function Footer() {
  return (
   <div  className='px-[8.375rem]' >
    <div className='flex mt-[200px] pb-[62px]  justify-between border-b-[0.5px] border-solid border-[ #BDBDBD] '>
...
<div className="flex items-end">
    ...
    <div>
  <p  className='text-lg leading-7  text-[" #595959;
...
<div className='flex flex-col space-y-4'>
  <h1 className='text-xl font-semibold'style={{fontFamily:"Outfit"}}>COMPANY</h1>
  <h1>Home</h1>
  <h1>About Us</h1>
  <h1>Delivery</h1>
  <h1>Privacy Policy</h1>
   ...
   <div className='flex flex-col space-y-4'>
  <h1 className='text-xl font-semibold'style={{fontFamily:"Outfit"}}>GET IN TOUCH</h1>
...
"] style={{fontFamily:"Outfit"}} ' >
      <h1 className='text-center'>Copyright 2024 © GreatStack.dev - All Right Reserved.</h1>
    </div>
